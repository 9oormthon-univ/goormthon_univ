...
export const ACTIVITY_DATA = [
  ...
  },
  {
    ...
    description:
      '본 해커톤이 끝난 후 2개 이상의 유니브가 모여 연합 해커톤 세미나를\n진행하여 타 대학과 네트워킹을 더 할 수 있는 시간을 가질 수 있어요.',
  },
  {
    imgSrc: Img4,
    title: '에프터파티',
    title_en: 'GUAP',
    description:
      'GUAP는 Goormthon Univ After Party의 약자로, 해커톤의 대상 및 최우수 수상자들과\n현직 전문가들이 세미나를 진행합니다. 또한 지금까지의 과정을 회고하는 시간을 갖습니다.',
  },
];
